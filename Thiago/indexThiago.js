...
updateProgressBar('progressBar1', 'progressPercent1', 80); // BARRA 1
...
const translations = {
  ...
  "section-projects-text1": "Portfolio Website - JavaScript + HTML + CSS + DATABASE",
  "section-projects-text2": "Valorant Pro Registry (VPR) - Java | MySQL | Swing | CRUD | Desktop Application",
